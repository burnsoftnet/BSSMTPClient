...
Module modMain
    ...
    Sub init()
        ...
        MAIL_PASSWORD = GetCommand("pwd", System.Configuration.ConfigurationManager.AppSettings("MAIL_PASSWORD"))
        ...
        If PROXY_USE Then
            ...
            PROXY_PWD = GetCommand("proxypwd", System.Configuration.ConfigurationManager.AppSettings("PROXY_PWD"))
    ...
    Sub ShowHelp()
        ...
        Console.WriteLine()
        Console.WriteLine("BSSMTPClient /host=[machine] /port=[port] /user=[email] /pwd=[password] /usetsl /to=[email] ")
        ...
        Console.WriteLine()
        Console.WriteLine("NOTE: Everything listed above except for the to, cc, bcc, subject, attache and message can also be ")
        Console.WriteLine(" set in the " & My.Application.Info.AssemblyName & ".exe.config")
        Console.WriteLine()
        Call PressToExit()
    End Sub
    ''' <summary>
    ...
    Sub Main()
        ...
        Obj.SendMail(Message_To, MAIL_USER, Message_Subject, Message_Body)
        Obj = Nothing
    End Sub
